...
from core import API_ID, API_HASH, STRING_SESSION, SESSION_ADI, CMD_HELP
from core.misc.eklenti_listesi import eklentilerim
from core.misc._pyrogram.pyro_yardimcilari import yanitlanan_mesaj, kullanici
...
`.thor` «__eklenti__» **komutuyla da eklenti hakkında bilgi alabilirsin..**
"""
...
async def logsalla(client:Client, message:Message):
    ...
    await client.send_document(chat_id=message.chat.id, document= f"@{SESSION_ADI}.log", caption="**ThorUserBot Log**", reply_to_message_id=yanit_id)
